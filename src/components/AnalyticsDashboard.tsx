    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '30px', padding: '10px 0' }}>
      ...
      <div style={{
        ...
        <div className="glass-panel" style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          <div style={{ width: '48px', height: '48px', borderRadius: '12px', background: 'rgba(99, 102, 241, 0.12)', display: 'flex', alignItems: 'center', justifySelf: 'center', justifyContent: 'center', color: '#6366f1' }}>
            <Award size={24} />
          </div>
          <div>
            <p style={{ fontSize: '13px', color: varName('--text-secondary') }}>Active Streak</p>
            <h3 style={{ fontSize: '24px', fontWeight: 700, color: '#f3f4f6' }}>
        ...
        {/* Metric 2 */}
        <div className="glass-panel" style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          <div style={{ width: '48px', height: '48px', borderRadius: '12px', background: 'rgba(16, 185, 129, 0.12)', display: 'flex', alignItems: 'center', justifySelf: 'center', justifyContent: 'center', color: '#10b981' }}>
            <Calendar size={24} />
          </div>
          <div>
            <p style={{ fontSize: '13px', color: varName('--text-secondary') }}>Total Reviews</p>
            <h3 style={{ fontSize: '24px', fontWeight: 700, color: '#f3f4f6' }}>
        ...
        {/* Metric 3 */}
        <div className="glass-panel" style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          <div style={{ width: '48px', height: '48px', borderRadius: '12px', background: 'rgba(59, 130, 246, 0.12)', display: 'flex', alignItems: 'center', justifySelf: 'center', justifyContent: 'center', color: '#3b82f6' }}>
            <TrendingUp size={24} />
          </div>
          <div>
            <p style={{ fontSize: '13px', color: varName('--text-secondary') }}>Retention Accuracy</p>
            <h3 style={{ fontSize: '24px', fontWeight: 700, color: '#f3f4f6' }}>
        ...
        {/* Metric 4 */}
        <div className="glass-panel" style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          <div style={{ width: '48px', height: '48px', borderRadius: '12px', background: 'rgba(245, 158, 11, 0.12)', display: 'flex', alignItems: 'center', justifySelf: 'center', justifyContent: 'center', color: '#f59e0b' }}>
            <Layers size={24} />
          </div>
          <div>
            <p style={{ fontSize: '13px', color: varName('--text-secondary') }}>Total Cards</p>
            <h3 style={{ fontSize: '24px', fontWeight: 700, color: '#f3f4f6' }}>
      ...
      <div className="glass-panel" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <h4 style={{ fontSize: '16px', fontWeight: 600, color: '#f3f4f6' }}>Study Calendar (Last 12 Months)</h4>
          </div>
          <span style={{ fontSize: '12px', color: '#9ca3af' }}>Max Streak: {metrics.maxStreak} days</span>
        </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center', gap: '6px', fontSize: '11px', color: '#6b7280' }}>
          ...
          <div style={{ width: '8px', height: '8px', borderRadius: '1px', backgroundColor: 'rgba(99, 102, 241, 0.25)' }} />
          <div style={{ width: '8px', height: '8px', borderRadius: '1px', backgroundColor: 'rgba(99, 102, 241, 0.5)' }} />
          <div style={{ width: '8px', height: '8px', borderRadius: '1px', backgroundColor: 'rgba(99, 102, 241, 0.75)' }} />
          <div style={{ width: '8px', height: '8px', borderRadius: '1px', backgroundColor: '#6366f1' }} />
          <span>More</span>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div className="glass-panel" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <h4 style={{ fontSize: '16px', fontWeight: 600, color: '#f3f4f6' }}>7-Day Workload Forecast</h4>
          </div>
            ...
            {workloadForecast.map((bar, idx) => {
              ...
              return (
                <div key={idx} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flex: 1, gap: '8px' }}>
                  <span style={{ fontSize: '11px', fontWeight: 600, color: bar.count > 0 ? '#a5b4fc' : '#6b7280' }}>
                    {bar.count}
                  </span>
                  ...
                  <div style={{
                    ...
                    background: bar.count > 0 ? 'linear-gradient(to top, #4f46e5, #6366f1)' : 'rgba(255, 255, 255, 0.05)',
        ...
        <div className="glass-panel" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <h4 style={{ fontSize: '16px', fontWeight: 600, color: '#f3f4f6' }}>Card Mastery Breakdown</h4>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '14px', justifyContent: 'center', flex: 1 }}>
            ...
            <div style={{
              ...
              <div style={{ width: `${cardStates.reviewPct}%`, backgroundColor: '#10b981' }} title={`Review Mastery: ${cardStates.reviewCount} cards`} />
              <div style={{ width: `${cardStates.learningPct}%`, backgroundColor: '#3b82f6' }} title={`Learning: ${cardStates.learningCount} cards`} />
              <div style={{ width: `${cardStates.newPct}%`, backgroundColor: 'rgba(255,255,255,0.1)' }} title={`New: ${cardStates.newCount} cards`} />
            </div>
...
// CSS variable helper for styled object readability
const varName = (cssVar: string) => `var(${cssVar})`;
