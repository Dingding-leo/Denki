      ...
      >
        ...
        <div>
          ...
          <p style={{ fontSize: "13px", color: "#8e8e93", marginTop: "4px" }}>
            Create new flashcards or review and edit existing cards in this
            deck.
          </p>
        </div>
        ...
        >
          ...
          >
            <span
              style={{ fontSize: "12px", fontWeight: 600, color: "#0a84ff" }}
            >
              Quick Card Creator
            </span>
            <select
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <div
                            style={{
                              color: isExpanded ? "#0a84ff" : "#8e8e93",
                              display: "flex",
                              alignItems: "center",
                            }}
                          >
                          ...
                          <button
                            onClick={async () => {
                              ...
                              const ok = await confirmDialog({
                                title: "Delete card",
                                message:
                                  "Delete this card and its review history? This cannot be undone.",
                                confirmLabel: "Delete",
                                danger: true,
                              });
                              if (ok) {
                            ...
                            >
                              ...
                              >
                                ...
                                <select
                                  value={editCardType}
                                  onChange={(e) =>
                                    setEditCardType(e.target.value as CardType)
                                  }
                                  style={{
                                    background: "#1c1c1e",
                                    border: "1px solid rgba(255,255,255,0.1)",
                              ...
                              >
                                <button
                                  type="button"
                                  onClick={() =>
                                    card.id && void handleSaveEdit(card.id)
                                  }
                                  disabled={pendingAction !== null}
                                  style={{
                                    height: "28px",
                              ...
                              >
                                ...
                                >
                                  ...
                                  <span>
                                    Stability:{" "}
                                    <strong style={{ color: "#ffffff" }}>
                                      {card.stability.toFixed(2)}d
                                    </strong>
                                  </span>
                                  <span>
                                    Scheduled Interval:{" "}
                                    <strong style={{ color: "#ffffff" }}>
                                      {card.scheduledDays.toFixed(2)}d
                                    </strong>
                                  </span>
                                  {card.lastReviewed && (
                                    <span>
                                    ...
                                    onChange={async (e) => {
                                      ...
                                      if (ratingVal === 0) {
                                        const ok = await confirmDialog({
                                          ...
                                          message:
                                            "This permanently deletes the card’s review history and cannot be undone.",
                                          confirmLabel: "Reset card",
                                          danger: true,
                                        });
                                        if (!ok) return;
                                      }
                                      await store.manuallySetCardConfidence(
                                        card.id,
                                        ratingVal,
                                      );
                                    }}
                                  ...
                                  >
                                    ...
                                    {REVIEW_RATINGS.map((definition) => (
                                      <option
                                        ...
                                        value={definition.rating}
                                      >
                                        {definition.rating} - {definition.label}{" "}
